...
const members_ids = ref(memberStore.homies.reduce((accum, item) =>  [...accum, item.id], []))
</script>
<template>
    <BaseBlock>
        ...
        <NextButton :isDisabled="!Boolean(productStore.isEmpty())" :routeName="'AddProductsView'" :label="'К результатам!'"/>
    </BaseBlock>
</template>
